...
if (typeof myStorage !== 'undefined') {
    if (myStorage.getItem('Turn') === null) {
        ...
        //setNames carga los nombres de los usuarios de la app;
        setNames();
...
function setNames() {
    ...
    document.getElementById("h2X").innerHTML = player1.name;
    document.getElementById("h2O").innerHTML = player2.name;
    /*document.getElementById("h2X").innerHTML = prueba1;
    document.getElementById("h2O").innerHTML = prueba2;*/
}
...
function checkWin() {
    ...
    if (array[0][0] === check && array[0][1] === check && array[0][2] === check ||
        ...
        document.getElementById('winDiv').innerHTML = '<div><h1>¡Empate!</h1><p>Felicitaciones ' + player1.name + ' y '+ player2.name +'. Estuvo muy parejo. ¿Van por el desempate?</p><button onclick="restart()">Empezar nueva partida</button></div>';
...
function win(check) {
    if (check == "x" || check == "o") {
        document.getElementById('winDiv').innerHTML = '<div><h1>¡Ganó el jugador ' + check.toUpperCase() + '!</h1><button onclick="restart()">Empezar nueva partida</button></div>';
        document.getElementById('winDiv').className = "appear";
        blockButtons();
    }
}
